...
QStringList WBStringUtils::sortByLastDigit(const QStringList& sourceList)
{
...
QString WBStringUtils::netxDigitizedName(const QString& source)
{
...
QString WBStringUtils::toCanonicalUuid(const QUuid& uuid)
{
...
QString WBStringUtils::toUtcIsoDateTime(const QDateTime& dateTime)
{
    return dateTime.toUTC().toString(Qt::ISODate) + "Z";
}

QDateTime WBStringUtils::fromUtcIsoDate(const QString& dateString)
{
