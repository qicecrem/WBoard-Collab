...
class WBForeighnObjectsHandlerPrivate {
    WBForeighnObjectsHandlerPrivate(WBForeighnObjectsHandler *pq)
        : q(pq)
    {
    }
...
private:
    WBForeighnObjectsHandler *q;
    friend class WBForeighnObjectsHandler;
};

WBForeighnObjectsHandler::WBForeighnObjectsHandler()
    : d(new WBForeighnObjectsHandlerPrivate(this))
{
...
void WBForeighnObjectsHandler::cure(const QList<QUrl> &dirs)
{
...
void WBForeighnObjectsHandler::cure(const QUrl &dir)
{
    d->cure(dir);
}

void WBForeighnObjectsHandler::copyPage(const QUrl &fromDir, int fromIndex, const QUrl &toDir, int toIndex)
{
